...
function MantenimientoCerebro() {
  ...
  const ACCIONES = [
    ...
    // Sin confirmación: solo RELLENA huecos, nunca pisa lo que ya está escrito.
    { id: "fichas", texto: "Completar fichas de la Cartera", fn: api.mantenimiento.completarFichas },
